...
public class ModelTest extends UnitTest {
	...
	@Test
	public void test1(){
		User u1 = new User("user1", "password1", "email1");
		u1.save();
		User u2 = new User("user2", "password2", "email2");
		u2.save();
		User u3 = new User("user3", "password3", "email3");
		u3.save();
	...
	@Test
	public void test5(){
		User u1 = new User("usur1", "password1", "email1");
		u1.save();
		...
		User u4 = new User("user4", "password4", "email4");
		u4.follows.add(u1);
		u4.follows.add(u2);
		u4.follows.add(u3);
		u4.save();
	...
	public void test8(){
		...
		User u1 = new User("user1", null, null);
		u1.save();
		tx.commit();
